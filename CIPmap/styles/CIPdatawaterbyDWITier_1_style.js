var size = 0;
var placement = 'point';
function categories_CIPdatawaterbyDWITier_1(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'Tier 1':
...
var style_CIPdatawaterbyDWITier_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_CIPdatawaterbyDWITier_1(feature, value, size, resolution, labelText,
